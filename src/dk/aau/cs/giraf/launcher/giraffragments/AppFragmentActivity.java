...
import dk.aau.cs.giraf.launcher.giraffragments.appfragments.AppSettingsPagerAdapter;
...
public class AppFragmentActivity extends FragmentActivity {
    ...
    AppSettingsPagerAdapter mDemoCollectionPagerAdapter;
    ViewPager mViewPager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.settings_appfragment_main);
        ...
        mDemoCollectionPagerAdapter =
                new AppSettingsPagerAdapter(getSupportFragmentManager());
