 ...
 */
public abstract class LoadApplicationTask extends AsyncTask<Application, View, HashMap<String, AppInfo>> {
     ...
     * @param targetLayout The layout that the AppImageViews should be put into
